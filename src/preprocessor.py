...
# Define a set of stop words by combining spaCy and NLTK stop words
STOP_WORDS = set(spacy_stop_words).union(set(nltk_stop_words.words("english")))
SPACY_TOKENIZER = spacy.load('en_core_web_sm')

# Function to separate capitalized words in a text
...
# Function to fix white spaces in text
...
# Function to remove non-alphanumeric characters and spaces from text
...
# Function to preprocess text by applying various transformations
...
# Function to preprocess articles, split them into sections, and apply text preprocessing
...
# Function to preprocess data, including text preprocessing, section splitting, and deduplication
def preprocess_data(input_filename:str, sample_size=None, section_by:str=None, input_types:list=[])->str:
    ...
    # Define output filenames for processed data, article IDs, and stats
